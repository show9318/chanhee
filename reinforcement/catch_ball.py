...
class CatchBall:
    def __init__(self):
        # 파라미터
        self.name = os.path.splitext(os.path.basename(__file__))[0] #os path를 통해 확장자와 그외 부분으로 나눔
        self.screen_n_rows = 8                                      #행,열 플레이어,액션, 프레임속도
    ...
    def draw(self):
        # reset screen, numpy를 통한 다차원 배열 설정
